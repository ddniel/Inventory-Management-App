    ...
    <div className="h-screen w-full bg-blue-400 flex items-center justify-center">
      <Card>
        ...
        <form className="flex flex-col items-center w-full mt-4 mb-3">
          <input required type="password" placeholder="New Password" name="password" className="text-sm bg-blue-100 px-3 py-2 rounded-3xl my-2 w-full" />
          <input required type="password" placeholder="Confirm Password" name="password" className="text-sm bg-blue-100 px-3 py-2 rounded-3xl my-2 w-full mb-6" />
