  ...
  return (
    <div className="h-screen w-full bg-blue-400 flex items-center justify-center">
      ...
      <Card>
        ...
        <form onSubmit={register} className="flex flex-col items-center w-full mt-4 mb-3">
          <input required type="text" placeholder="Name" name="name" value={name} onChange={handleInputChange}  className="text-sm bg-blue-100 px-3 py-2 rounded-3xl my-2 w-full" />
          ...
          <input required type="password" placeholder="Password" name="password" value={password} onChange={handleInputChange} className="text-sm bg-blue-100 px-3 py-2 rounded-3xl my-2 w-full" />
          <input required type="password" placeholder="Confirm password" name="cpassword" value={cpassword} onChange={handleInputChange} className="text-sm bg-blue-100 px-3 py-2 rounded-3xl my-2 w-full mb-6" />
